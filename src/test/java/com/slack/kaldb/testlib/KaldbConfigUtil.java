...
public class KaldbConfigUtil {
  ...
  public static KaldbConfigs.KaldbConfig makeKaldbConfig(String bootstrapServers, int serverPort, String kafkaTopic, int kafkaPartition, String kafkaClientGroup, String s3Bucket) {
