...
public abstract class ValuesSource {
    ...
    /**
     * Get the current {@link Bytes.WithScript.BytesValues}.
     */
...
//                return com.slack.kaldb.logstore.aggregations.FieldData.emptySortedNumericDoubles();
            }
...
//                return com.slack.kaldb.logstore.aggregations.FieldData.emptySortedBinary();
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            if (isFloatingPoint()) {
                ...
                return com.slack.kaldb.logstore.aggregations.FieldData.docsWithValue(values);
            } else {
