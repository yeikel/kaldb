        ...
        public ValuesSource getField(FieldContext fieldContext) { //}, AggregationScript.LeafFactory script) {
            if ((fieldContext.indexFieldData() instanceof IndexNumericFieldData) == false) {
                ...
                throw new IllegalArgumentException(
                    "Expected numeric type on field [" + fieldContext.field() + "], but got [" + fieldContext + "]"
                );
            }
...
//        @Override
//        public ValuesSource getField(FieldContext fieldContext) { //}, AggregationScript.LeafFactory script) {
//            return BYTES.getField(fieldContext);
...
//                );
//            }
//            if (fieldContext.fieldType().isSearchable() == false || fieldContext.fieldType() instanceof DateFieldMapper.DateFieldType == false) {
//                /*
...
//            return NUMERIC.getField(fieldContext, script);
            return NUMERIC.getField(fieldContext);
        }
