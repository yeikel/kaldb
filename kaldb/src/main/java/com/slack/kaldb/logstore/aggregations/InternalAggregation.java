...
//            ScriptService scriptService,
            Supplier<PipelineAggregator.PipelineTree> pipelineTreeForBwcSerialization
        ) {
//            return new ReduceContext(bigArrays, scriptService, (s) -> {}, null, pipelineTreeForBwcSerialization);
            return new ReduceContext(bigArrays, (s) -> {}, null, pipelineTreeForBwcSerialization);
        }
        ...
        public static ReduceContext forFinalReduction(
            ...
            PipelineAggregator.PipelineTree pipelineTreeRoot
        ) {
...
//    protected abstract void doWriteTo(StreamOutput out) throws IOException;
    ...
    public InternalAggregation copyWithRewritenBuckets(Function<InternalAggregations, InternalAggregations> rewriter) {
        throw new IllegalStateException(
            "Aggregation [" + getName() + "] must be a bucket aggregation but was [" + getName() + "]"
        );
//        throw new IllegalStateException(
