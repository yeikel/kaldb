...
public class FacetModule { // extends SearchComponent {
  ...
  //        fcontext.flags |=
  //            FacetContext
  //                .SKIP_FACET; // the root bucket should have been received from all shards
  // previously
  //      }
  //    }
  //    if (rb.isDebug()) {
  ...
  //
  //      // String finfoStr = JSONUtil.toJSON(finfo, -1);  // this doesn't handle formatting of
  // Date
  ...
  //    boolean isShard;
  //    Map<String, Object>
  //        facetInfo; // _facet_ param: contains out-of-band facet info, mainly for refinement
  // requests
  //
  //    //
  ...
  //  abstract static class FacetBucketMerger<FacetRequestT extends FacetRequest> extends
  // FacetMerger {
  //    FacetRequestT freq;
  //
  ...
  //        // if this bucket was missing, we need to get all subfacets that have partials (that
  // need to
