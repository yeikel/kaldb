...
public class SortedNumericIndexFieldData extends IndexNumericFieldData {
    ...
    @Override
    protected XFieldComparatorSource dateComparatorSource(Object missingValue, MultiValueMode sortMode, XFieldComparatorSource.Nested nested) {
    ...
    @Override
    protected XFieldComparatorSource dateNanosComparatorSource(Object missingValue, MultiValueMode sortMode, XFieldComparatorSource.Nested nested) {
