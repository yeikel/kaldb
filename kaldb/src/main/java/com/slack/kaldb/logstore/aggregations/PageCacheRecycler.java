...
import static com.slack.kaldb.logstore.aggregations.Recyclers.concurrent;
import static com.slack.kaldb.logstore.aggregations.Recyclers.concurrentDeque;
import static com.slack.kaldb.logstore.aggregations.Recyclers.dequeFactory;
import static com.slack.kaldb.logstore.aggregations.Recyclers.none;
...
//    );
    ...
    public PageCacheRecycler() {
        ...
        final long limit = 0L;
        final int allocatedProcessors = 1; // OpenSearchExecutors.allocatedProcessors(settings);
...
//        final int allocatedProcessors = OpenSearchExecutors.allocatedProcessors(settings);
        ...
        // of Unsafe writes.
        final double bytesWeight = 1; //WEIGHT_BYTES_SETTING.get(settings);
        final double intsWeight = 1; //WEIGHT_INT_SETTING.get(settings);
        final double longsWeight = 1; //WEIGHT_LONG_SETTING.get(settings);
        final double objectsWeight = 1; //WEIGHT_OBJECTS_SETTING.get(settings);
