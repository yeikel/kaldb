...
public abstract class MetricsAggregator extends AggregatorBase {
    protected MetricsAggregator(String name, Aggregator parent, Map<String, Object> metadata) throws IOException {
        super(name, parent, CardinalityUpperBound.NONE, new Aggregator[]{}, metadata);
