...
public abstract class NumericMetricsAggregator extends MetricsAggregator {
    ...
    private NumericMetricsAggregator(String name, Aggregator parent, Map<String, Object> metadata)
        throws IOException {
...
//            super(name, context, parent, metadata);
//        }
        protected SingleValue(String name, Aggregator parent, Map<String, Object> metadata) throws IOException {
            super(name, parent, metadata);
        }
    ...
    public abstract static class MultiValue extends NumericMetricsAggregator {
        ...
        protected MultiValue(String name, Aggregator parent, Map<String, Object> metadata) throws IOException {
            super(name, parent, metadata);
        }
