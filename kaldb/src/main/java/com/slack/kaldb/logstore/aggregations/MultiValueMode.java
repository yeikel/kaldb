...
public enum MultiValueMode { //} implements Writeable {
    ...
    public NumericDocValues select(
        ...
        if (parentDocs == null || childDocs == null) {
            return com.slack.kaldb.logstore.aggregations.FieldData.replaceMissing(DocValues.emptyNumeric(), missingValue);
        }
    ...
    public NumericDoubleValues select(final SortedNumericDoubleValues values) {
        final NumericDoubleValues singleton = com.slack.kaldb.logstore.aggregations.FieldData.unwrapSingleton(values);
        if (singleton != null) {
            return singleton;
        } else {
    ...
    public NumericDoubleValues select(
        ...
        if (parentDocs == null || childDocs == null) {
            return com.slack.kaldb.logstore.aggregations.FieldData.replaceMissing(FieldData.emptyNumericDouble(), missingValue);
        }
    ...
    public BinaryDocValues select(final SortedBinaryDocValues values, final BytesRef missingValue) {
        final BinaryDocValues singleton = com.slack.kaldb.logstore.aggregations.FieldData.unwrapSingleton(values);
        if (singleton != null) {
    ...
    public BinaryDocValues select(
        ...
        if (parentDocs == null || childDocs == null) {
            return select(com.slack.kaldb.logstore.aggregations.FieldData.emptySortedBinary(), missingValue);
        }
